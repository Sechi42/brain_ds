...
- Follow `workspace.documentation_language` and `documentation_language_contract` for all user-facing documentation and card sections; keep tool names, graph ids, and code-like values unchanged.
