...
3. Open your agent client in this repo and verify `/mcp` shows **25 tools**
...
Then open your client in this repo and confirm `/mcp` shows `brain_ds` connected with **25 tools**.
